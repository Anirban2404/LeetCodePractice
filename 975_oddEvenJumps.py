...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun  8 12:51:27 2019
...
1. During odd numbered jumps (ie. jumps 1, 3, 5, ...), you jump to the index j 
...
2. During even numbered jumps (ie. jumps 2, 4, 6, ...), you jump to the index j 
...
During our 3rd jump (odd numbered), we jump from i = 2 to i = 3 because A[3] is 
the smallest value in (A[3], A[4]) that is greater than or equal to A[2].
...
In total, there are 3 different starting indexes (i = 1, i = 3, i = 4) where we 
